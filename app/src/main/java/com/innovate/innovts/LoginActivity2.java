 ...
 */
public class LoginActivity2 extends AppCompatActivity implements LoaderCallbacks<Cursor>, UICallback {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            if (!checkinternet.displaynetstatus(LoginActivity2.this, true)) {
                SharedPreferences sp = getSharedPreferences("auth", MODE_PRIVATE);
                SharedPreferences.Editor et = sp.edit();
                et.putString("email", email);
                et.putString("password", password);
                et.commit();
                HttpResponse.listener("auth", "http://103.254.180.108:8082/api/devices", LoginActivity2.this, 0);
            }
        }
    }
